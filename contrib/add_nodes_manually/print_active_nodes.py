...
"""
Agregar nodos de remitt manualmente obteniendo la información desde el explorador de bloques
Manually add remitt nodes to daemon
(python 3.x)
"""
import json
import requests
...
try:
    ...
    if data.status_code == 200: # OK
        ...
        print("\nPlease run addnodes.sh to add nodes to remitt daemon.")
    else:
        print(f"Remitt Blockchain Explorer not responding ( {URL_EXPLORER} )")
